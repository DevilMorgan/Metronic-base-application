    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.teams.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sube_sehir') ? 'is-invalid' : '' }}" type="text" name="sube_sehir" id="sube_sehir" value="{{ old('sube_sehir', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sube_kodu') ? 'is-invalid' : '' }}" type="number" name="sube_kodu" id="sube_kodu" value="{{ old('sube_kodu', '') }}" step="1">
