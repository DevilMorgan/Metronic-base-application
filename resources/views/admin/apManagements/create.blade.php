...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.apManagement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ap-managements.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="ap_name">{{ trans('cruds.apManagement.fields.ap_name') }}</label>
                <input class="form-control {{ $errors->has('ap_name') ? 'is-invalid' : '' }}" type="text" name="ap_name" id="ap_name" value="{{ old('ap_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_ip_address') ? 'is-invalid' : '' }}" type="text" name="ap_ip_address" id="ap_ip_address" value="{{ old('ap_ip_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_username') ? 'is-invalid' : '' }}" type="text" name="ap_username" id="ap_username" value="{{ old('ap_username', 'admin') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ap_marka_model') ? 'is-invalid' : '' }}" name="ap_marka_model" id="ap_marka_model">
                    ...
                    @foreach(App\Models\ApManagement::AP_MARKA_MODEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ap_marka_model', 'Mikrotik') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('mikrotik_api_version') ? 'is-invalid' : '' }}" name="mikrotik_api_version" id="mikrotik_api_version">
                    ...
                    @foreach(App\Models\ApManagement::MIKROTIK_API_VERSION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('mikrotik_api_version', '6.43') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_ssh_port') ? 'is-invalid' : '' }}" type="number" name="ap_ssh_port" id="ap_ssh_port" value="{{ old('ap_ssh_port', '22') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_api_port') ? 'is-invalid' : '' }}" type="number" name="ap_api_port" id="ap_api_port" value="{{ old('ap_api_port', '8728') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('ap_permission_yonet') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="ap_permission_yonet" id="ap_permission_yonet" value="1" {{ old('ap_permission_yonet', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ap_status') ? 'is-invalid' : '' }}" name="ap_status" id="ap_status">
                    ...
                    @foreach(App\Models\ApManagement::AP_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ap_status', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ap_port_speed') ? 'is-invalid' : '' }}" name="ap_port_speed" id="ap_port_speed">
                    ...
                    @foreach(App\Models\ApManagement::AP_PORT_SPEED_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ap_port_speed', '1 Gbit Ethernet') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ApManagement::AUTO_BACKUP_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('auto_backup') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="auto_backup_{{ $key }}" name="auto_backup" value="{{ $key }}" {{ old('auto_backup', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_vlan') ? 'is-invalid' : '' }}" type="number" name="ap_vlan" id="ap_vlan" value="{{ old('ap_vlan', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_max_wlan_register') ? 'is-invalid' : '' }}" type="number" name="ap_max_wlan_register" id="ap_max_wlan_register" value="{{ old('ap_max_wlan_register', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_max_pppoe') ? 'is-invalid' : '' }}" type="number" name="ap_max_pppoe" id="ap_max_pppoe" value="{{ old('ap_max_pppoe', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_switch_port_number') ? 'is-invalid' : '' }}" type="number" name="ap_switch_port_number" id="ap_switch_port_number" value="{{ old('ap_switch_port_number', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ap_station') ? 'is-invalid' : '' }}" name="ap_station_id" id="ap_station_id">
                    @foreach($ap_stations as $id => $ap_station)
                        <option value="{{ $id }}" {{ old('ap_station_id') == $id ? 'selected' : '' }}>{{ $ap_station }}</option>
                    @endforeach
                </select>
