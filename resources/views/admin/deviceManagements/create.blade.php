...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.deviceManagement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.device-managements.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="ap_mikrotik_default_username">{{ trans('cruds.deviceManagement.fields.ap_mikrotik_default_username') }}</label>
                <input class="form-control {{ $errors->has('ap_mikrotik_default_username') ? 'is-invalid' : '' }}" type="text" name="ap_mikrotik_default_username" id="ap_mikrotik_default_username" value="{{ old('ap_mikrotik_default_username', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_mikrotik_default_password') ? 'is-invalid' : '' }}" type="text" name="ap_mikrotik_default_password" id="ap_mikrotik_default_password" value="{{ old('ap_mikrotik_default_password', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mikrotik_api_default_port') ? 'is-invalid' : '' }}" type="text" name="mikrotik_api_default_port" id="mikrotik_api_default_port" value="{{ old('mikrotik_api_default_port', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_mikrotik_default_ssh') ? 'is-invalid' : '' }}" type="text" name="ap_mikrotik_default_ssh" id="ap_mikrotik_default_ssh" value="{{ old('ap_mikrotik_default_ssh', '') }}">
