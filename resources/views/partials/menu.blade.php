        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('user_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/users*") ? "menu-open" : "" }} {{ request()->is("admin/permissions*") ? "menu-open" : "" }} {{ request()->is("admin/roles*") ? "menu-open" : "" }} {{ request()->is("admin/teams*") ? "menu-open" : "" }}">
                            ...
                            @can('user_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.users.index") }}" class="nav-link {{ request()->is("admin/users") || request()->is("admin/users/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fab fa-yelp">
                ...
                @can('client_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/clients*") ? "menu-open" : "" }} {{ request()->is("admin/projects*") ? "menu-open" : "" }} {{ request()->is("admin/notes*") ? "menu-open" : "" }} {{ request()->is("admin/documents*") ? "menu-open" : "" }} {{ request()->is("admin/transactions*") ? "menu-open" : "" }} {{ request()->is("admin/client-reports*") ? "menu-open" : "" }} {{ request()->is("admin/baglanti-testis*") ? "menu-open" : "" }} {{ request()->is("admin/network-alerts*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-briefcase">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('baglanti_testi_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.baglanti-testis.index") }}" class="nav-link {{ request()->is("admin/baglanti-testis") || request()->is("admin/baglanti-testis/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.baglantiTesti.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
                            @can('network_alert_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.network-alerts.index") }}" class="nav-link {{ request()->is("admin/network-alerts") || request()->is("admin/network-alerts/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.networkAlert.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
