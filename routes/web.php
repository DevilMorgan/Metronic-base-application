...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa', 'admin']], function () {
    ...
    // Baglanti Testi
    Route::delete('baglanti-testis/destroy', 'BaglantiTestiController@massDestroy')->name('baglanti-testis.massDestroy');
    Route::resource('baglanti-testis', 'BaglantiTestiController');

    // Network Alert
    Route::delete('network-alerts/destroy', 'NetworkAlertController@massDestroy')->name('network-alerts.massDestroy');
    Route::resource('network-alerts', 'NetworkAlertController');
